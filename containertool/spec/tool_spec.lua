...
describe("Tool behavior", function()
	...
	before_each(function()
		local worldmeta_node1 = minetest.get_meta(P.protected_chest)
		worldmeta_node1:set_string("owner", "dummy")
		worldmeta_node1:set_string("mineunit_test_meta", "not changed 0")
		worldmeta_node1:set_string("key_lock_secret", "key_lock_secret 0")
		worldmeta_node1:set_int("splitstacks", 100)
		local worldmeta_node2 = minetest.get_meta(P.unprotected_chest)
		worldmeta_node2:set_string("owner", "SX")
		worldmeta_node2:set_string("mineunit_test_meta", "not changed 1")
		worldmeta_node2:set_string("key_lock_secret", "key_lock_secret 1")
		worldmeta_node2:set_int("splitstacks", 101)
		local worldmeta_node3 = minetest.get_meta(P.protected_injector)
		worldmeta_node3:set_string("owner", "dummy")
		worldmeta_node3:set_string("mineunit_test_meta", "not changed 2")
		worldmeta_node3:set_int("splitstacks", 102)
		local worldmeta_node4 = minetest.get_meta(P.unprotected_injector)
		worldmeta_node4:set_string("owner", "SX")
		worldmeta_node4:set_string("mineunit_test_meta", "not changed 3")
		worldmeta_node4:set_int("splitstacks", 103)
		tooldata = {
			data = {
